...
namespace CIC_MultiModule
{
    class Program
    {
        static readonly string MASTER_IP = "10.100.35.186"; // IP address (or hostname) of the 3050 LAN-XI module (PTP master)
        static readonly string SLAVE_IP = "10.100.35.111"; // IP address (or hostname) of the 3160 LAN-XI module (PTP slave)
