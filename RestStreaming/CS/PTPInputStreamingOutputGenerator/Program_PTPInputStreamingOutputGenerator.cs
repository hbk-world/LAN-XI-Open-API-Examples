...
namespace PTPInputStreamingOutputGenerator
{
    class Program
    {
        static readonly string MASTER_IP = "10.10.3.1"; // IP address (or hostname) of the first LAN-XI module (PTP master)
        static readonly string SLAVE_IP  = "10.10.4.1"; // IP address (or hostname) of the second LAN-XI module (PTP slave)
